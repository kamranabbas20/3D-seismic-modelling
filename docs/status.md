...
| — | sim2seis synthetic volume | done | `imaging.method: sim2seis`; Aki-Richards angle stacks, one pinned time axis across scenarios, zero-angle stack equals the preview exactly |
